...
use crate::extensions::history_modal::selection::selected_project_path::selected_conversation_picker_project_path;
...
pub fn open_selected_conversation_project(app: &mut AppState) {
