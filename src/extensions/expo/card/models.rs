...
use crate::extensions::expo::filter::filter_cards::filter_expo_cards;
...
pub fn expo_card_models(app: &AppState) -> Vec<ExpoCardModel> {
...
fn card_model_for_index(app: &AppState, session_index: usize) -> Option<ExpoCardModel> {
