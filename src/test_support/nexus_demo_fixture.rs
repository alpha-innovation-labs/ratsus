...
/// Builds a minimal NexusDemo fixture without spawning terminal processes.
pub fn nexus_demo_fixture(session_terminals: Vec<SessionTerminal>) -> anyhow::Result<NexusDemo> {
