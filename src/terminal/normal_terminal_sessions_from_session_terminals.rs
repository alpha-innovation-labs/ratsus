...
use crate::terminal::persisted_normal_terminal_session_from_nexus_session::persisted_normal_terminal_session_from_nexus_session;
...
pub fn normal_terminal_sessions_from_session_terminals(
    ...
    sessions
        ...
        .map(|entry| persisted_normal_terminal_session_from_nexus_session(&entry.session))
        .collect()
}
