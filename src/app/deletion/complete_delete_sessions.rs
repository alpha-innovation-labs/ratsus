use crate::app::deletion::confirm_delete_session::delete_target_indices;
use crate::app::sessions::restore_focus_after_bulk_delete::restore_focus_after_bulk_delete;
