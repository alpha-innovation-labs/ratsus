...
pub fn sync_nexus_menu_bar_selection(menu_bar: &mut MenuBar, selected_index: usize) {
...
mod tests {
    ...
    use super::sync_nexus_menu_bar_selection;
    ...
    fn selects_only_requested_index() {
        ...
        sync_nexus_menu_bar_selection(&mut menu_bar, 2);
