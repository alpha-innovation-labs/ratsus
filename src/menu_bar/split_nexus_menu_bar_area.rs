...
pub fn split_nexus_menu_bar_area(area: Rect) -> (Rect, Rect) {
...
mod tests {
    ...
    fn handles_tiny_frames() {
        assert_eq!(
            split_nexus_menu_bar_area(Rect::new(0, 0, 120, 2)),
