...
/// Applies the shared pane border color to the rendered Nexus menu bar border cells.
pub fn style_nexus_menu_bar_border(buffer: &mut Buffer, area: Rect) {
...
mod tests {
    ...
    use super::style_nexus_menu_bar_border;
    use crate::rendering::default_border_color::default_border_color;
    ...
    fn styles_menu_bar_border_with_default_pane_color() {
        ...
        style_nexus_menu_bar_border(&mut buffer, area);
