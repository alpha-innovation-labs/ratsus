...
use crate::main_pane::render_file_preview::render_file_preview;
use crate::main_pane::render_file_system_tree_view::render_file_system_tree_view;
use crate::menu_bar::render_app_menu_bar::render_app_menu_bar;
use crate::menu_bar::split_app_menu_bar_area::split_app_menu_bar_area;
    ...
    if app.left_pane_visible {
        ...
        if app.active_main_pane_tab == MainPaneTab::Files {
            ...
            if is_resizing {
                ...
                render_file_system_tree_view(&mut app.file_system_tree_view, frame, left_inner);
            }
        } else {
...
fn render_left_pane(
    ...
    let title = if app.active_main_pane_tab == MainPaneTab::Files {
        " files ".to_string()
    } else {
        format!(
            " {} sessions ",
            app.chat_harness.display_name().to_lowercase()
        )
    };
